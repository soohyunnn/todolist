...
const webpack = require('webpack');		//이부분 추가!
const getClientEnvironment = require('./env');		//이부분 추가!
...
const publicUrl = paths.publicUrlOrPath.slice(0,-1);		//이부분 추가!
const env = getClientEnvironment(publicUrl);		//이부분 추가!
